...
#include <faster_lio_interface/msg/custom_msg.hpp>
...
class PointCloudPreprocess {
   public:
    ...
    /// processors
    void Process(const faster_lio_interface::msg::CustomMsg::SharedPtr &msg, PointCloudType::Ptr &pcl_out);
   ...
   private:
    void AviaHandler(const faster_lio_interface::msg::CustomMsg::SharedPtr &msg);
    ...
    void C16Handler(const sensor_msgs::msg::PointCloud2::SharedPtr &msg);
