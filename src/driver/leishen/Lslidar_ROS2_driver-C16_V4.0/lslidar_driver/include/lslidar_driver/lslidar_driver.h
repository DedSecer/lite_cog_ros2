...
// special defines for lslidarlidar support
    ...
    //unit:meter
    static const double R1_ = 0.0361;        // C16 4.0 or C32 4.0
    static const double R1_C32W = 0.03416;   // 新C32W   byte[1211] = 0x47
...
// Pre-compute the sine and cosine for the altitude angles.
    ...
    static const double c32_70_vertical_angle2[32] = {
            -54.7, -31, -9, 3, -51.5, -28, -7.5, 4.5,
            -49, -25, -6.0, 6.0, -46, -22, -4.5, 7.5,
            -43, -18.5, -3.0, 9, -40, -15, -1.5, 11,
            -37, -12, 0, 13, -34, -10.5, 1.5, 15};
...
//2°
    ...
    public:
        ...
        bool filter_voxel_;
        double filter_leaf_size_m_;

        bool filter_box_;
        bool crop_negative_;

        bool keep_organized_;
        double filter_front_m_;
        double filter_back_m_;
        double filter_left_m_;
        double filter_right_m_;
        double filter_lower_height_m_;
        double filter_higher_height_m_;
        ...
        double plane_sqrt_dividend_;
        double plane_filter_x_min_;
        double plane_filter_x_max_;
        double plane_filter_y_min_;
        double plane_filter_y_max_;
        ...
        bool  start_process_msop_ = false;
        bool is_new_c32w_ = true;
        bool is_get_scan_altitude_ = false;
    };
