...
void RegulatedPurePursuitController::cleanup()
{
  RCLCPP_INFO(
    ...
    "customized regulated_pure_pursuit_controller::RegulatedPurePursuitController",
    plugin_name_.c_str());
  ...
  const geometry_msgs::msg::PoseStamped & carrot_pose)
{
  ...
  return use_rotate_to_heading_ && (dist_to_goal < goal_dist_tol_ || rotating_to_heading_);
}
...
void RegulatedPurePursuitController::setPlan(const nav_msgs::msg::Path & path)
{
  ...
  global_plan_ = path;
  // RCLCPP_INFO(logger_, "Setting plan for regulated pure pursuit");
}
