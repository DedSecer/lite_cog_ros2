...
void PointCloudPreprocess::Process(const faster_lio_interface::msg::CustomMsg::SharedPtr &msg, PointCloudType::Ptr &pcl_out) {
    AviaHandler(msg);
    *pcl_out = cloud_out_;
}
...
void PointCloudPreprocess::AviaHandler(const faster_lio_interface::msg::CustomMsg::SharedPtr &msg) {
    cloud_out_.clear();
    cloud_full_.clear();
...
void PointCloudPreprocess::C16Handler(const sensor_msgs::msg::PointCloud2::SharedPtr &msg) {
    cloud_out_.clear();
    cloud_full_.clear();
