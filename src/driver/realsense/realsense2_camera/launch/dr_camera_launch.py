...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera', 'description': 'camera unique name'},
                           ...
                           {'name': 'depth_fps',                    'default': '30.0', 'description': ''},
                           ...
                           {'name': 'reconnect_timeout',            'default': '1.', 'description': 'Timeout(seconds) between consequtive reconnection attempts'},

                           {'name': 'filter_voxel',                  'default': 'true', 'description': ''},
                           {'name': 'filter_leaf_size_m',            'default': '0.05', 'description': ''},
                          ]
